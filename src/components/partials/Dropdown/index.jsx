      ...
      <CustomScrollbar className="navigation__menu">
        ...
        >
          <div className="menu">
            <DropdownItem
              ...
              onClick={goTo} data={{ url: 'https://twitch.tv/' + login}}
            >
        ...
        <CSSTransition
          ...
          <div className="menu">
            ...
            <DropdownItem onClick={setLanguage} data={{ lang: 'ru'}} rightIcon={state.lang === 'ru' ? 'done' : '' }>
              <div className="menu-item-title">{Strings.russian[state.lang]}</div>
            </DropdownItem>
            <DropdownItem onClick={setLanguage} data={{ lang: 'en'}} rightIcon={state.lang === 'en' ? 'done' : '' }>
